...
return temp;}
function themerex_in_list(str,list){"use strict";var delim=arguments[2]?arguments[2]:'|';var icase=arguments[3]?arguments[3]:true;var retval=false;if(icase){str=str.toLowerCase();list=list.toLowerCase();}
...
color+=Math.round((aRGB[i][aRGB[i].length-1]=="%"?2.55:1)*parseInt(aRGB[i]),16).toString(16).replace(/^(.)$/,'0$1');}else
